...
export class UpdateLocalChangesSchema1745288090311 implements MigrationInterface {
    name = 'UpdateLocalChangesSchema1745288090311'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sync_metadata" ("id" text NOT NULL, "client_id" text NOT NULL, "current_lsn" text NOT NULL DEFAULT '0/0', "sync_state" text NOT NULL DEFAULT 'disconnected', "last_sync_time" TIMESTAMP WITH TIME ZONE, "pending_changes_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_fbdfc072a3e60cc5086d9d84b05" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "local_changes" DROP COLUMN "processed_sync"`);
        await queryRunner.query(`ALTER TABLE "local_changes" ADD "processed_sync" integer NOT NULL DEFAULT '0'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_comments_entity_type_entity_id"`);
        await queryRunner.query(`ALTER TABLE "local_changes" DROP COLUMN "processed_sync"`);
        await queryRunner.query(`ALTER TABLE "local_changes" ADD "processed_sync" boolean NOT NULL DEFAULT false`);
