...
export class NullableRelationFields1743825190961 implements MigrationInterface {
    name = 'NullableRelationFields1743825190961'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_comments_entity_type_entity_id" ON "comments" ("entity_id", "entity_type") `);
        await queryRunner.query(`ALTER TABLE "comments" ADD CONSTRAINT "FK_e6d38899c31997c45d128a8973b" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
