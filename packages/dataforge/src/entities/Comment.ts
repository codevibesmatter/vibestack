import { Entity, Column, PrimaryGeneratedColumn, CreateDateColumn, UpdateDateColumn, ManyToOne, Index, Relation } from 'typeorm';
import { 
  IsString, 
  MinLength, 
  IsUUID, 
...
export class Comment {
  ...
  // Polymorphic relationships - these are used based on entityType
  @ManyToOne(() => Task)
  task?: Relation<Task>;
