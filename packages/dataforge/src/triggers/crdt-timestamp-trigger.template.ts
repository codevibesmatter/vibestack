...
/**
 * Template migration for adding CRDT timestamp trigger to domain tables
 * To use:
 * 1. Copy to src/migrations/server/
 * 2. Update the timestamp in class name and name property
 * 3. Run migration
 */
export class AddCRDTTimestampTriggers0 implements MigrationInterface {
    name = 'AddCRDTTimestampTriggers0'
